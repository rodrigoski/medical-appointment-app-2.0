<x-admin-layout>
    <x-slot name="title">Nuevo Seguro</x-slot>
    ...
    <div class="container mx-auto px-6 py-4">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-xl font-bold text-gray-800">Nuevo Seguro</h3>
                    <p class="text-sm text-gray-500">Registra un nuevo convenio o seguro médico</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="description" rows="4" maxlength="2000"
                              ...
                              class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
