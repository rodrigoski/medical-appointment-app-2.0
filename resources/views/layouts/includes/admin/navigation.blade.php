  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <!-- Botón del Sidebar: Asegúrate que el ID coincida con tu <aside id="top-bar-sidebar"> -->
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex ms-2 md:me-24">
          <img src="{{ asset('images/logo_medico.png') }}" class="h-9 me-3" alt="SIMIRODRO" />
          <span class="self-center text-lg font-semibold whitespace-nowrap">SIMIRODRO</span>
        </a>
      </div>
